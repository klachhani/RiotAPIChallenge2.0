...
function champBarChart(queryType, regions, tiers, results_url, mode, per5min, reverse) {

    if (per5min == true){per5min = "-per5min";} else {per5min = "";}
    ...
    $.getJSON(query_url, function(data){
        ...
        if (reverse == true){dataSorted = dataSorted.reverse()}
